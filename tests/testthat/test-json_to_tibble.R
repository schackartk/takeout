...
test_that("works with good local guides file", {
  #expect_equal(ncol(json_to_tibble("sample_ratings_reviews.json")), 4)
  #expect_equal(nrow(json_to_tibble("sample_ratings_revies.json")), 3)
})
